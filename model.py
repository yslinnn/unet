...
def unet(pretrained_weights = None,input_size = (256,1)):
    ...
    pool1 = MaxPooling1D(pool_size=(2, 1))(conv1)
    ...
    pool2 = MaxPooling1D(pool_size=(2, 1))(conv2)
    ...
    pool3 = MaxPooling1D(pool_size=(2, 1))(conv3)
    ...
    pool4 = MaxPooling1D(pool_size=(2, 1))(drop4)
    ...
    up6 = Conv1D(512, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(drop5))
    ...
    up7 = Conv1D(256, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv6))
    ...
    up8 = Conv1D(128, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv7))
    ...
    up9 = Conv1D(64, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv8))
